...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Matchup.insider_matchup_path'
        db.add_column('matchups', 'insider_matchup_path', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Matchup.insider_matchup_path'
        db.delete_column('matchups', 'insider_matchup_path')
