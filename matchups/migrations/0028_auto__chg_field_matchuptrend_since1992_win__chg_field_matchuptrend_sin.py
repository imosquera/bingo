...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MatchupTrend.since1992_win'
        db.alter_column('matchup_trends', 'since1992_win', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))

        # Changing field 'MatchupTrend.since1992_loss'
        db.alter_column('matchup_trends', 'since1992_loss', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))


    def backwards(self, orm):
        
        # Changing field 'MatchupTrend.since1992_win'
        db.alter_column('matchup_trends', 'since1992_win', self.gf('django.db.models.fields.IntegerField')(max_length=5))

        # Changing field 'MatchupTrend.since1992_loss'
        db.alter_column('matchup_trends', 'since1992_loss', self.gf('django.db.models.fields.IntegerField')(max_length=5))
