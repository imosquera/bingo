...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matchup.current_line'
        db.alter_column('matchups', 'current_line', self.gf('django.db.models.fields.FloatField')(max_length=4, null=True, blank=True))

        # Changing field 'Matchup.starting_line'
        db.alter_column('matchups', 'starting_line', self.gf('django.db.models.fields.FloatField')(max_length=4, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Matchup.current_line'
        db.alter_column('matchups', 'current_line', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True))

        # Changing field 'Matchup.starting_line'
        db.alter_column('matchups', 'starting_line', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True))
    ...
    models = {
        'matchups.matchup': {
            ...
            'game_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'}),
