...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teams', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Team.insider_name'
        db.add_column('teams', 'insider_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, primary_key=True), keep_default=False)
