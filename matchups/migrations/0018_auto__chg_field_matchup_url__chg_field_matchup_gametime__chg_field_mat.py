...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matchup.url'
        db.alter_column('matchups', 'url', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Matchup.gametime'
        db.alter_column('matchups', 'gametime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Matchup.game_id'
        db.alter_column('matchups', 'game_id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Matchup.url'
        db.alter_column('matchups', 'url', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Matchup.gametime'
        db.alter_column('matchups', 'gametime', self.gf('django.db.models.fields.DateField')())
