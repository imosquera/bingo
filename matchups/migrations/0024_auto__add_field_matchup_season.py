...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Matchup.season'
        db.add_column('matchups', 'season', self.gf('django.db.models.fields.IntegerField')(default=2011, max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Matchup.season'
        db.delete_column('matchups', 'season')
