...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Matchup.rank'
        db.alter_column('matchups', 'rank', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Matchup.rank'
        db.alter_column('matchups', 'rank', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True))
