...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Team.statfox_name'
        db.alter_column('teams', 'statfox_name', self.gf('django.db.models.fields.CharField')(max_length=1024))
    ...
    models = {
        ...
        'matchups.team': {
            ...
            'statfox_name': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'})
        }
    }
