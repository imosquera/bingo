...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Matchup.is_over'
        db.add_column('matchups', 'is_over', self.gf('django.db.models.fields.CharField')(max_length=8, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Matchup.is_over'
        db.delete_column('matchups', 'is_over')
