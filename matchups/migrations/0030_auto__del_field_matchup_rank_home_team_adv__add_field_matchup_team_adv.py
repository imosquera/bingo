...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Matchup.rank_home_team_adv'
        db.delete_column('matchups', 'rank_home_team_adv')

        # Adding field 'Matchup.team_advantage'
        db.add_column('matchups', 'team_advantage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='matchup_advantages', null=True, to=orm['matchups.Team']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Matchup.rank_home_team_adv'
        db.add_column('matchups', 'rank_home_team_adv', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Matchup.team_advantage'
        db.delete_column('matchups', 'team_advantage_id')
    ...
    models = {
        'matchups.matchup': {
            ...
            'is_over': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True'}),
            ...
            'team_advantage': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'matchup_advantages'", 'null': 'True', 'to': "orm['matchups.Team']"}),
        ...
        'matchups.matchuptrend': {
            ...
            'since1992_loss': ('django.db.models.fields.IntegerField', [], {'max_length': '5', 'null': 'True'}),
            'since1992_win': ('django.db.models.fields.IntegerField', [], {'max_length': '5', 'null': 'True'}),
