...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Matchup.over_under'
        db.add_column('matchups', 'over_under', self.gf('django.db.models.fields.FloatField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Matchup.over_under'
        db.delete_column('matchups', 'over_under')
