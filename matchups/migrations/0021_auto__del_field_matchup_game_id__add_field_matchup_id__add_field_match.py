...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Matchup.game_id'
        db.delete_column('matchups', 'game_id')
        ...
        # Adding field 'Matchup.insider_game_id'
        db.add_column('matchups', 'insider_game_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Matchup.game_id'
        db.add_column('matchups', 'game_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, primary_key=True), keep_default=False)

        # Deleting field 'Matchup.id'
        db.delete_column('matchups', 'id')

        # Deleting field 'Matchup.insider_game_id'
        db.delete_column('matchups', 'insider_game_id')
