...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Matchup.filepath'
        db.add_column('matchups', 'filepath', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Matchup.filepath'
        db.delete_column('matchups', 'filepath')
