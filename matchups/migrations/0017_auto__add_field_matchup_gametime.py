...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Matchup.gametime'
        db.add_column('matchups', 'gametime', self.gf('django.db.models.fields.DateField')(default=None), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Matchup.gametime'
        db.delete_column('matchups', 'gametime')
    ...
    models = {
        'matchups.matchup': {
            ...
            'gametime': ('django.db.models.fields.DateField', [], {}),
